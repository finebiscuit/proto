...
var file_auth_v1_auth_proto_rawDesc = []byte{
	...
	0x32, 0x9a, 0x02, 0x0a, 0x04, 0x41, 0x75, 0x74, 0x68, 0x12, 0x4b, 0x0a, 0x06, 0x53, 0x69, 0x67,
	...
	0x6b, 0x65, 0x6e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x42, 0x35, 0x5a,
	0x33, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x66, 0x69, 0x6e, 0x65,
	0x62, 0x69, 0x73, 0x63, 0x75, 0x69, 0x74, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x62, 0x69,
	0x73, 0x63, 0x75, 0x69, 0x74, 0x2f, 0x61, 0x75, 0x74, 0x68, 0x2f, 0x76, 0x31, 0x3b, 0x61, 0x75,
...
var file_auth_v1_auth_proto_depIdxs = []int32{
	9, // 0: biscuit.auth.v1.Session.created_at:type_name -> google.protobuf.Timestamp
	9, // 1: biscuit.auth.v1.Session.expires_at:type_name -> google.protobuf.Timestamp
	...
	3, // 6: biscuit.auth.v1.Auth.SignUp:input_type -> biscuit.auth.v1.SignUpRequest
	5, // 7: biscuit.auth.v1.Auth.CreateSession:input_type -> biscuit.auth.v1.CreateSessionRequest
	7, // 8: biscuit.auth.v1.Auth.GetAccessToken:input_type -> biscuit.auth.v1.GetAccessTokenRequest
	4, // 9: biscuit.auth.v1.Auth.SignUp:output_type -> biscuit.auth.v1.SignUpResponse
	6, // 10: biscuit.auth.v1.Auth.CreateSession:output_type -> biscuit.auth.v1.CreateSessionResponse
	8, // 11: biscuit.auth.v1.Auth.GetAccessToken:output_type -> biscuit.auth.v1.GetAccessTokenResponse
